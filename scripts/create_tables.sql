...
CREATE TABLE facturation (
    ...
    CONSTRAINT fk_facturation_utilisateurs FOREIGN KEY (id_utilisateur) REFERENCES utilisateurs_statique (id_utilisateur),
...
CREATE TABLE incident (
    ...
    CONSTRAINT fk_incident_utilisateurs FOREIGN KEY (id_utilisateur_responsable) REFERENCES utilisateurs_statique (id_utilisateur),
...
CREATE TABLE monitoring (
    ...
    CONSTRAINT fk_monitoring_utilisateurs FOREIGN KEY (id_utilisateur) REFERENCES utilisateurs_statique (id_utilisateur),
