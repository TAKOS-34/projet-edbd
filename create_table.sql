...
CREATE TABLE incident (
    id_incident NUMBER(20) GENERATED BY DEFAULT AS IDENTITY,
    ...
    CONSTRAINT uk_incident_natural UNIQUE (id_utilisateur_responsable, id_agent, id_localisation, id_ressource, id_date, id_heure, id_statut),
...
CREATE TABLE monitoring (
    ...
    id_date NUMBER(20),
    id_heure NUMBER(20),
    CPU_utilisation NUMBER(5, 2),
    GPU_utilisation NUMBER(5, 2),
    RPM_ventilateur NUMBER(10),
    RPM_GPU_ventilateur NUMBER(10),
    est_actif NUMBER(1),
    temps_total_actif NUMBER(10, 2),
...
BEGIN EXECUTE IMMEDIATE 'DROP TABLE pont_utilisateurs_incident CASCADE CONSTRAINTS'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;
/

CREATE TABLE pont_utilisateurs_incident (
    id_utilisateur NUMBER(20),
    id_incident NUMBER(20),
    CONSTRAINT pk_pont_u_i PRIMARY KEY (id_utilisateur, id_incident),
    CONSTRAINT fk_pont_utilisateurs FOREIGN KEY (id_utilisateur) REFERENCES utilisateurs (id_utilisateur),
    CONSTRAINT fk_pont_incident FOREIGN KEY (id_incident) REFERENCES incident (id_incident)
)